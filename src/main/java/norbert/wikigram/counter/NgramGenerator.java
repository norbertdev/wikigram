...
/**
 * This class provides a transformation from several ordered characters to
 * strings of a determined length.
 *
 * The characters are added one by one, via the {@link #putChar(char)} method.
 * The string is retrieved by the {@link #getString()} method. The number of
 * characted is given to the constructor.
 *
 * In the initial state, the string is empty. A generator is in the initial
 * state after the constructor call, and after the call of the {@link #reset()}
 * method.
 *
...
public class NgramGenerator {
	...
	/**
	 * Constructs a generator that will generate string of the given number of
	 * characters.
	 *
	 * @param length
	 *            number of character
	...
	/**
	 * Returns a string composed of the last characters put in the generator. If
	 * not enough characters were inserted before, <code>null</code> is
	 * returned.
	 *
	 * The returned strings always contain the same number of characters. This
	 * number is given to the constructor.
	 *
	 * The insertion order is preserved: for a length of 3,
	 * <code>putChar('a'); putChar('b'); putChar('c');</code> results in the
	 * "abc" string.
	 *
