...
public class FrenchAlphabet implements Alphabet {
	private static final Character ALPHABET_ARRAY[] = { 'a', 'à', 'â', 'æ',
			'b', 'c', 'ç', 'd', 'e', 'é', 'è', 'ê', 'ë', 'f', 'g', 'h', 'i',
			'î', 'ï', 'j', 'k', 'l', 'm', 'n', 'o', 'ô', 'œ', 'p', 'q', 'r',
	...
	/**
	 * Returns <code>true</code> if the given character belongs to the French
	 ...
	 * @param c
	 *            character to test
	 * @return <code>true</code> if the given character belongs to the French
	 *         alphabet, <code>false</code> otherwise.
	 */
	@Override
