...
public class FrenchAlphabet implements Alphabet {
  private static final Character ALPHABET_ARRAY[] = {'a', 'à', 'â', 'æ', 'b', 'c', 'ç', 'd', 'e',
      'é', 'è', 'ê', 'ë', 'f', 'g', 'h', 'i', 'î', 'ï', 'j', 'k', 'l', 'm', 'n', 'o', 'ô', 'œ',
      'p', 'q', 'r', 's', 't', 'u', 'ù', 'û', 'ü', 'v', 'w', 'x', 'y', 'ÿ', 'z'};
  private static final Collection<Character> ALPHABET = new HashSet<Character>(
      Arrays.asList(ALPHABET_ARRAY));

  /**
   * Returns <code>true</code> if the given character belongs to the French alphabet,
   * <code>false</code> otherwise.
   *
   * The alphabet only contains the lower case characters.
   *
   * @param c character to test
   * @return <code>true</code> if the given character belongs to the French alphabet,
   *         <code>false</code> otherwise.
   */
  @Override
