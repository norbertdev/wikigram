...
/**
 * This interface provides a way to detect if an alphabet contains a character.
 */
public interface Alphabet {
	/**
	 * Returns <code>true</code> if the given character belongs to the alphabet, <code>false</code> otherwise.
	 * 
	 * @param c character to test
	 * @return <code>true</code> if the given character belongs to the alphabet, <code>false</code> otherwise.
	 */
