 ...
 *
 * This class is intended to be use as an index that goes from <code>0</code> to a given length-1.
 * This index is incremented at each step by the {@link #next()} method. If the index reaches the
 * maximum allowed value, then the next step will lower the index to 0.
 *
...
public class LoopingIndex {
  ...
  /**
   * Constructs an index that goes from <code>0</code> to a default value. The first value is
   * <code>0</code>.
   */
  public LoopingIndex() {
    this(DEFAULT_LENGTH);
  ...
  /**
   * Constructs an index that goes from <code>0</code> to <code>length-1</code>. The first value is
   * <code>0</code>.
   *
   * The given length must be greater than <code>0</code>.
   *
   * @param length length allowed for the created index.
   */
  ...
  /**
   * Constructs an index based on another index: it will get the same length and the same current
   * value.
   *
  ...
  /**
   * Returns the current value of the index. The returned value is always in the range [0,
   * length-1].
   *
