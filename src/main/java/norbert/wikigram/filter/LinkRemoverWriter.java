 ...
 *
 * For this class, a link is every character between the char "[" and the char "]". Thus, this
 * writer may remove characters that are not part of a link.
 */
public class LinkRemoverWriter extends EnclosedCharRemoverWriter {
  ...
  public LinkRemoverWriter(Writer nextWriter) {
