 ...
 *
 * For this writer, a HTML tag is every character between the char "<" and the char ">". Thus, this
 * writer may remove characters that are not part of a HTML tag.
 */
public class HtmlTagRemoverWriter extends EnclosedCharRemoverWriter {
  ...
  public HtmlTagRemoverWriter(Writer nextWriter) {
    super(nextWriter, OPENING_TEMPLATE_CHAR, CLOSING_TEMPLATE_CHAR);
  }
}
